...
xhr.onload = function(){
    ...
    //Loop each article record into its own HTML table row, each article should
    //have a link an article view
    // 12.28 for parallel test w users, restricting cols but did not work; reconforming cols specs to match users
...
<!--
            ...
            <input type="keywords" id="description" name="keywords" class="form-control" required>
          </div>
        </div>
-->
  ...
  form.addEventListener('submit', function(e){
    ...
    xhr.onload = function(){
      ...
      if(data.success===true){
        window.location.href = `#view-${data.article._id}`;
      }else{
